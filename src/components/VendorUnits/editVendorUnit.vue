<template>
     <div class="modal fade in" id="editVendorUnitInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <label id="error" class="label-danger"><span v-show="errors.has('name')||errors.has('contactPerson')" class="help is-danger">请输入红框中的必填项</span></label>
                <button type="button" class="btn btn-primary" id="btnConfirm" @click="submitEdit">确认</button>
  ...
  methods:{   
      ...
      submitEdit(){
        ...
        // eslint-disable-next-line
                  ...
                  $("#editVendorUnitInfo").modal("toggle")
      }).catch(() => {
        // eslint-disable-next-line
      }); 
