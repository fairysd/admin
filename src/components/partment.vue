            ...
            <div class="modal-body forms">
                 <div class="form-inline">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <p class="form-control-static" v-text="contactInfo.name"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static" v-text="contactInfo.address"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <p class="form-control-static" v-text="contactInfo.type1"></p>
                        </div>
                        <div class="col-sm-2">
                            <label class="control-label">联系方式2</label>
                        </div>
                        <div class="col-sm-4">
                            <p class="form-control-static" v-text="contactInfo.type2"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <p class="form-control-static" v-text="contactInfo.type3"></p>
                        </div>
                        <div class="col-sm-2">
                            <label class="control-label">联系方式4</label>
                        </div>
                        <div class="col-sm-4">
                            <p class="form-control-static" v-text="contactInfo.type4"></p>
                        </div>
                    </div>
                </div>
            </div>
